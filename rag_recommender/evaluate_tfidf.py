"""
Evaluation script for the TF-IDF based SHL Assessment Recommendation System.
...
def run_evaluation(k=3):
    ...
    metrics = evaluate_test_set(search_assessments_tfidf, TEST_QUERIES, k)
    ...
    for i, test_case in enumerate(TEST_QUERIES):
        ...
        try:
            recommended = search_assessments_tfidf(query)
            logging.info(f"\nQuery {i+1}: {query[:50]}...")
